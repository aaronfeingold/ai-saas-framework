...
// Embedding model for query (Voyage AI)
...
// Function to query Supabase vectors with RPC function
async function queryDocumentVectors(
  ...
  return matches.map((match: Record<string, unknown>) => ({
    ...
    filterTags: match.filter_tags as string,
  ...
  tool({
    ...
    execute: async (args, { messages }) => {
      ...
      try {
        ...
        // Get example links for the system prompt
